...
const DashProfile = () => {
    return (
      <div className="flex h-[100vh] justify-center items-center gap-5 bg-[#F7F6F9]  w-full container mx-auto">
        {/* left column  */}
        ...
        <div className="md:w-1/3 ">
          <div className="flex space-y-4 w-max flex-col justify-center items-center bg-white p-8 rounded-xl">
            ...
            <div className="w-full space-y-4">
              ...
              <p className='text-sm text-blue-gray-400'> * recommended size minimum 550px</p>
            </div>
          </div>
        </div>
      </div>
